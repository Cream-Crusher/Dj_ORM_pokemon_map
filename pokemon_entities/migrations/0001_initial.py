# Generated by Django 3.1.14 on 2022-10-14 13:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degradation', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='Деградация', to='pokemon_entities.pokemon', verbose_name='Деградация')),
                ('evolution', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='Эволюция', to='pokemon_entities.pokemon', verbose_name='Эволюция')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
            fields=[
                ...
                ('pokemon', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pokemon', to='pokemon_entities.pokemon', verbose_name='Покемон')),
            ],
        ),
    ]
